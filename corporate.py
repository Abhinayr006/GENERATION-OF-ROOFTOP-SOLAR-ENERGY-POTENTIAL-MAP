...
model = tf.keras.models.load_model(
    "/home/tondamanati-abhinay/Desktop/capstone/Capstone/DataSet/DS/full_model_epoch_05.keras",
    custom_objects={
        "dice_coef": dice_coef,
...
# LOAD IMAGE
# -----------------------------
image_path = "/home/tondamanati-abhinay/Desktop/capstone/Capstone/DataSet/DS/train/images/000000006691.jpg"
display_crop = 15
...
# PREDICTION
# -----------------------------
img_array = image_rgb / 255.0
img_array = np.expand_dims(img_array, axis=0)

prediction = model.predict(img_array)
mask = prediction[0, :, :, 0]  # RAW (important)

# -----------------------------
# BINARY MASK (for display only)
# -----------------------------
...
for i, poly in enumerate(polygons):
    ...
    # Convert to discrete panels
    panels = int((system_kw * 1000) / panel_power)

    # Enforce real installable system
    system_kw = (panels * panel_power) / 1000

    # NOW add to total (after correction)
    ...
    print("System Size (kW):", round(system_kw,2))   # ← BETTER METRIC
    print("Panels:", panels)
